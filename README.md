...
int main(void)
{
    ...
    while (1)
    {
        ...
        float voltage = (inp_val * 3.3f) / 4095.0f;
        sprintf(msg, "%hu  \r\n", inp_val, voltage);
...
<img width="1000" height="800" alt="Serial Port Utility - Trial Edition 11-11-2025 09_16_47" src="https://github.com/user-attachments/assets/5358b29e-cb33-40bc-a32b-2648227c3a03" />

![WhatsApp Image 2025-11-11 at 09 17 51_6a74b2f1](https://github.com/user-attachments/assets/fa7f4eeb-147a-4d04-9931-123743970591)
